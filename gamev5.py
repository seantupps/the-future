...
def main_game():
    ...
    while running:
        ...
        if not paused:
            ...
            # Create pause menu buttons if not already created
            if not pause_buttons:
                settings_button = Button((WIDTH / 2 - 100, HEIGHT / 2 - 50, 200, 50), "Settings", settings_menu)
                scores_button = Button((WIDTH / 2 - 100, HEIGHT / 2 + 10, 200, 50), "High Scores", high_scores_menu)
                resume_button = Button((WIDTH / 2 - 100, HEIGHT / 2 + 70, 200, 50), "Resume", pause_game)
                pause_buttons.extend([resume_button, settings_button, scores_button])
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    update_screen_size(event.w, event.h)
                    # Update button positions
                    resume_button.rect.topleft = (WIDTH / 2 - 100, HEIGHT / 2 + 70)
                    resume_button.text_rect.center = resume_button.rect.center
                    settings_button.rect.topleft = (WIDTH / 2 - 100, HEIGHT / 2 - 50)
                    settings_button.text_rect.center = settings_button.rect.center
                    scores_button.rect.topleft = (WIDTH / 2 - 100, HEIGHT / 2 + 10)
                    scores_button.text_rect.center = scores_button.rect.center
